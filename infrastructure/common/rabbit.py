...
class RabbitEventPublisher(EventPublisher):
    def __init__(self, channel_pool: Pool[AbstractChannel], exchange_name: str = 'pipeline_events') -> None:
    ...
    async def publish_status(self, event: StatusEvent) -> None:
        ...
        # Получится "ingest.status" или "registration.status"
    ...
    async def publish_completed(self, result: ScenarioResult) -> None:
        ...
        # Получится "ingest.completed" или "registration.completed"
    ...
    async def publish_failed(self, event: FailedEvent) -> None:
        ...
        # Получится "ingest.failed" или "registration.failed"
